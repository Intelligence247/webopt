...
const Subscribe = () => {
  return (
    ...
    <div className='w-full bg-[#7647D4] rounded-lg h-[25.3rem] text-white flex flex-col justify-center items-center lg:space-y-10 space-y-6 '>
        <h1 className='lg:text-[3.5rem] text-[2rem] text-center lg:leading-[3.5rem] leading-8'>Subscribe to Our Newsletter</h1>
        <p className='lg:w-[48rem] w-full lg:text-base text-sm px-4 text-center'>Stay up to date with the latest e-commerce trends, tips, and insights by subscribing to our newsletter. Join our community and receive regular updates, exclusive offers, and valuable information right in your inbox. Don't miss out on the opportunity to supercharge your online business!</p>
